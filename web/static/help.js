...
if %errorlevel% equ 0 (
    ...
    set ANTHROPIC_AUTH_TOKEN=YOUR_CLIENT_AUTH_TOKEN_HERE
...
if [ $? -eq 0 ]; then
    ...
    export ANTHROPIC_AUTH_TOKEN="YOUR_CLIENT_AUTH_TOKEN_HERE"
